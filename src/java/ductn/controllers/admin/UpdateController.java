...
//        System.out.println("file name : " + fileName);
        ...
        try {
            if (fileName.equals("")) {
                ProcessBean find = new ProcessBean();
                find.setAccessoryID(updateID);
                AccessoryDTO model = find.findAcessoryByPrimaryKey();
                fileName = model.getImage();
            } else {
                uploadImg(request, fileName, filePart);
            }

            AccessoryDTO dto = new AccessoryDTO(Integer.parseInt(updateID), Integer.parseInt(price), name, description, fileName, Integer.parseInt(quantity));
            ProcessBean bean = new ProcessBean();
            bean.setAcessoryDTO(dto);
            if (bean.updateAccessory()) {
