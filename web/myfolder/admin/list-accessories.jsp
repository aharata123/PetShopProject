                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.LIST}" var="item">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img src="/project/images/${item.image}" width="100" height="100">
                                                            </td>
                                                             <td>
                                                                ${item.quantity}
                                                            </td>
                                                            ...
                                                            <td>
                                                                <c:url value="AdminController" var="Delete">
                                                                    <c:param name="deleteID" value="${item.accessoryID}"/>
                                                                    <c:param  name="action" value="Delete"/>
                                                                </c:url>
    <!--                                                            <a href="${Delete}" class="btn btn-danger a-btn-slide-text">
                                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                                                    <i class="nc-icon nc-simple-remove"></i>
                                                                </a>-->

                                                                <button type="button" class="btn btn-danger a-btn-slide-text deleteBtn" value="${item.accessoryID}">
                                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                                                    <i class="nc-icon nc-simple-remove"></i>
                                                                </button>
...
<!--                                                            <button type="button" class="btn btn-primary a-btn-slide-text" data-toggle="modal" data-target="#editModal" value="${item.accessoryID}"><span class="glyphicon glyphicon-edit" aria-hidden="true">
         <i class="nc-icon nc-paper"></i> 
 </button>    -->
                                                                <button type="button" class="btn btn-primary a-btn-slide-text editBtn" onclick="editAccessory(this)"  value="${item.accessoryID}"><span class="glyphicon glyphicon-edit" aria-hidden="true">
                                                                        <i class="nc-icon nc-paper"></i> 
                                                                </button> 
                                                            </td>
                                ...
                                <div class="modal-body">
                                    <form action="AddController" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="price" placeholder="Enter price" name="txtPrice" required min="0" step="1000">
                                        </div>
                                        <div class="form-group">
            ...
            $(".deleteBtn").on("click", function () {
                swal({
                    ...
                    dangerMode: true,
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                var href = "AdminController?action=Delete&&deleteID=" + $(this).val();
